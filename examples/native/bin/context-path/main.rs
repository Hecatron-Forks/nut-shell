//! Basic example demonstrating nut-shell usage with context-path
//!
//! This example creates a simple CLI with a single command that is re-used within the tree,
//! The handler recieves a path that can be used to determine
//! which directory path the command is being called from
//!
//! To run:
//! ```bash
//! cargo run --bin context-path --features context-path
//! ```
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    println!("nut-shell context-path example");
    println!("=======================\n");
